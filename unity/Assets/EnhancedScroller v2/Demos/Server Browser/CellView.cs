...
public class CellView : EnhancedScrollerCellView
{
    ...
    {
        _data = data;
        someTextText.text = $"{data.name.Replace("_", " ")}\nHost: {data.host.Replace("_", " ")}\n{data.currentPlayers} Players";
    }
    ...
    public void CellButtonText_OnClick()
    {
        ...
        if (cellButtonTextClicked != null) cellButtonTextClicked(_data.room_name);
    }
